...
<div id="print">
	...
	<div id="cetak"  class="btn btn-default"></div>
...
gadget1.setPrintButton( cloudprint.Gadget.createDefaultPrintButton("cetak")); 
gadget1.setPrintDocument( "text/html", "Gadget test", 
